...
try {
    ...
    @{l = 'ruleInclAllCount'; e = { if ($_.isDefault -eq $true -or $_.isBuiltInProtection -eq $true) { "default" }else { $_.ruleInclUsersCount + $_.ruleInclGroupsCount + $_.ruleInclDomainsCount } } },
